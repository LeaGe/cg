...
bool Exercise62::hasAnimation()
{
	return true;
}

const QString Exercise62::hints() const
{
	return "Keys:\n\t[SPACE] : Pause/Resume animation.";
}

bool Exercise62::initialize(Camera &camera)
{
    AbstractExercise::initialize(camera);

	m_drawable = ObjIO::fromObjFile("data/bunny_sparser.obj");
...
void Exercise62::render(const Camera &camera)
{
...
int main(int argc, char *argv[])
{
	...
	// Create main window
	GLViewer viewer(new Exercise62);
	viewer.show();
